...
<div class="nk-main ">
    ...
    <div class="nk-wrap ">
                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            ...
                            <div class="nk-block-between">
                                ...
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Método de pago
                        ...
                        <div class="nk-block">
                                ...
                                @foreach ($paymentTypes as $paymentType)
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            <div class="user-card">
                                                <div class="user-avatar bg-primary">
                                                    <span>{{ htmlspecialchars(ucfirst(substr($paymentType->name ?? '', 0, 1))) }}</span>
                                                </div>
                                                <div class="user-info">
                                                    <span
                                                        class="tb-lead">{{ htmlspecialchars($paymentType->name ?? '') }}
                                        ...
                                        <div class="nk-tb-col tb-col-md">
                                            ...
                                            <button data-id="{{ $paymentType->id }}"
                                                data-name="{{ $paymentType->name }}" data-toggle="modal"
                                                data-target="#editpaymentModal" class="btn btn-success edit-payment">
                                                <em class="icon ni ni-edit"></em>
                                            </button>

                                            <a href="/delete-paymentTypes/{{ $paymentType->id }}"
                            ...
                            <div class="card" id="no-results-message" style="display: none;">
                                <div class="card-inner">
                                    ...
                                    <b>No se encontraron tipos de pago.
                                    </b>
        ...
        {{--  modal start Add New  payment Type  --}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content"> <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Agregar Nuevo Método de pago
                        </h5>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('add-paymentType') }}" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        {{-- modal End Add New  payment Type --}}


        <!-- payment Type Update Modal S -->
        ...
        <div class="modal fade" id="editpaymentModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editpaymentModalLabel">Editar método de pago
                        </h5>
                    ...
                    <div class="modal-body">
                        <form id="editpaymentForm">
                            @csrf
                            <input type="hidden" name="id" id="payment-type-id">
                            <div class="form-group">
                                <label for="payment-type-name">Nombre</label>
                                <input type="text" class="form-control" id="payment-type-name" name="name"
                                    required>
                            </div>
