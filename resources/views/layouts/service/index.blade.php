                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            ...
                            <div class="nk-block-between">
                                ...
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Complementos</h3>
                                </div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            <div class="user-card">
                                                <div class="user-avatar bg-primary">
                                                    <span>{{ htmlspecialchars(ucfirst(substr($service->name ?? '', 0, 1))) }}</span>
                                                </div>
                                                <div class="user-info">
                                                    <span class="tb-lead">{{ htmlspecialchars($service->name ?? '') }}
                                        ...
                                        <div class="nk-tb-col tb-col-md">
                                            ...
                                            <button data-id="{{ $service->id }}" data-name="{{ $service->name }}"
                                                data-price="{{ $service->price }}" data-toggle="modal"
                                                data-target="#editserviceModal" class="btn btn-success edit-servise">
                                                <em class="icon ni ni-edit"></em>
                                            </button>

                                            <a href="/delete-service/{{ $service->id }}" class="btn btn-danger ">
                                        ...
                                        <div class="g">
                                            ...
                                            <ul class="pagination justify-content-center justify-content-md-start">
                                                ...
                                                @if ($services->hasMorePages())
                                                    <li class="page-item">
                                                        <a class="page-link"
                                                            href="{{ $services->nextPageUrl() }}">Next</a>
                                                    </li>
                                                @else
                                                    <li class="page-item disabled">
                                                        <a class="page-link" href="#" tabindex="-1"
        ...
        <div class="modal fade" id="editserviceModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editserviceModalLabel">Editar tipo de complementos
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editserviceForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="service-price" name="price"
                                    required>
                            </div>
